      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="bg-white p-1 rounded-lg shadow-sm border border-slate-200 flex">
            <button onClick={() => setRange("day")} className={`px-4 py-2 text-sm font-bold rounded-md transition ${range === "day" ? "bg-blue-600 text-white shadow" : "text-slate-600 hover:bg-slate-50"}`}>
              Aujourd'hui
            </button>
            <button onClick={() => setRange("month")} className={`px-4 py-2 text-sm font-bold rounded-md transition ${range === "month" ? "bg-blue-600 text-white shadow" : "text-slate-600 hover:bg-slate-50"}`}>
              Ce Mois
            </button>
            <button onClick={() => setRange("year")} className={`px-4 py-2 text-sm font-bold rounded-md transition ${range === "year" ? "bg-blue-600 text-white shadow" : "text-slate-600 hover:bg-slate-50"}`}>
              Cette Année
            </button>
          </div>
        </div>
